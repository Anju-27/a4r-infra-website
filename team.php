...
<head>
    ...
    object-position: top;
        ...
        .team-img img {
            ...
            height: 100%;
            object-fit: cover;
            /* Image content ke barabar stretch hogi */
            border-radius: 12px;
     ...
     <section class="team-section">
        <div class="container">
           <div class="main-section-title">
				<h2 data-aos="fade-up">Chairman's Message</h2>
			</div>
                        ...
                        <div class="team_c_rad">
                            ...
                            <div class="overlay">
                                <div>
                                    ...
                                    <p class="mb-0 det_ail" style="text-align:justify">Mr. Alok Kumar Aggarwal is a B.Tech Civil Engineering and M.Tech in Highway and Traffic Engineering. With a professional journey spanning over 28 years, he has worked extensively in India’s road and highway sector, managing major infrastructure projects across the country.</p>
                                    <p class="mb-0  det_ail" style="text-align:justify">Over the years, he has successfully delivered projects worth more than ₹15,000 crores, covering expressways, national highways, railway overbridges, and performance-based maintenance contracts under NHAI, MoRTH, and various State PWDs. He has held senior leadership positions in well-known infrastructure companies, leading teams and delivering high-quality results with a focus on efficiency, safety, and compliance.</p>
                                    <p class="mb-0  det_ail" style="text-align:justify">With a deep understanding of both construction and maintenance challenges, Mr. Aggarwal established A4R Infra Pvt. Ltd. to focus on highway maintenance and asset management—a field he believes is key to preserving national infrastructure. Under his leadership, the company has quickly gained recognition for its dedicated approach to road upkeep, performance-based solutions, and operational excellence.</p>
                                    <p class="mb-0  det_ail" style="text-align:justify">He continues to guide A4R Infra with a strong emphasis on timely delivery, quality work, and long-term value for public infrastructure.</p>
                            ...
                            <div class="team_c_rad">
                                ...
                                <div class="overlay">
                                    <div>
                                        ...
                                        <p class="mb-0 det_ail" style="text-align:justify">Vikas Vaid is a seasoned finance professional with over 26 years of experience in accounting, taxation, EPC project billing, and vendor reconciliation. He has worked with leading infrastructure companies, managing multi-crore highway and power projects across India. Skilled in SAP, Tally ERP, Farvision, and Tally Prime, he brings expertise in cash flow management, statutory compliance, and internal audits. At A4R Infra, he oversees finance and accounts, ensuring strong financial discipline, operational efficiency, and smooth coordination with banks, subcontractors, and auditors. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
