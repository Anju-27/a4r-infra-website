...
<table cellpadding="0" cellspacing="0" width="50%" border="0" style="background-color:#ffeeac;">
		...
		<tr height="30">
		<td style="padding:10px 30px 5px;"> <b>Name :</b> '.$_REQUEST['fullname'].'</td>
		</tr>
			<tr height="30">
		<td style="padding:10px 30px 5px;"> <b>subject :</b> '.$_REQUEST['subject'].'</td>
		</tr>
		<tr height="30">
		<td style="padding:10px 30px 5px;"> <b>Contact Number :</b> '.$_REQUEST['phone'].'</td>
		</tr>
		<tr height="30">
		<td style="padding:10px 30px 5px;"> <b>Email ID :</b> '.$_REQUEST['emailid'].'</td>
		</tr>
		
	
		
		<tr height="30">
		<td style="padding:10px 30px 5px;"> <b>comments  :</b> '.$_REQUEST['comments'].'</td>
		</tr>
    ...
    $mail->Subject = "Recieve New Enquiry A4infra"; // Subject (which isn't required)  
  ...
  /* $mail->addBCC('bcc@example.com');*/
	...
	$message = $result ? 'We Have Receive Your Request, We Will Contact  Soon' : 'Sending Failed!';      
	unset($mail);
